...
{
    public class FieldSearchCondition2DetailLayout : ComponentBase
    {
        public BooleanFieldDriver Boolean => ByCssSelector("div[data-name='Boolean']").Wait();
        public LabelFieldDriver DateStartLabel => ByCssSelector("div[data-name='DateStartLabel']").Wait();
        public DateFieldDriver DateStart => ByCssSelector("div[data-name='DateStart']").Wait();
        public LabelFieldDriver DateEndLabel => ByCssSelector("div[data-name='DateEndLabel']").Wait();
        public DateFieldDriver DateEnd => ByCssSelector("div[data-name='DateEnd']").Wait();
        public LabelFieldDriver DateTimeStartLabel => ByCssSelector("div[data-name='DateTimeStartLabel']").Wait();
        public DateTimeFieldDriver DateTimeStart => ByCssSelector("div[data-name='DateTimeStart']").Wait();
        public LabelFieldDriver DateTimeEndLabel => ByCssSelector("div[data-name='DateTimeEndLabel']").Wait();
        public DateTimeFieldDriver DateTimeEnd => ByCssSelector("div[data-name='DateTimeEnd']").Wait();
        public LabelFieldDriver IdXLabel => ByCssSelector("div[data-name='IdXLabel']").Wait();
        public IdFieldDriver IdX => ByCssSelector("div[data-name='IdX']").Wait();
        ...
        public LabelFieldDriver NumberStartLabel => ByCssSelector("div[data-name='NumberStartLabel']").Wait();
        public NumberFieldDriver NumberStart => ByCssSelector("div[data-name='NumberStart']").Wait();
        public LabelFieldDriver NumberEndLabel => ByCssSelector("div[data-name='NumberEndLabel']").Wait();
        public NumberFieldDriver NumberEnd => ByCssSelector("div[data-name='NumberEnd']").Wait();
        ...
        public RadioButtonFieldDriver RadioButtonC => ByCssSelector("div[data-name='RadioButtonC']").Wait();
        ...
        public LabelFieldDriver SelectLinkXLabel => ByCssSelector("div[data-name='SelectLinkXLabel']").Wait();
        public SelectFieldDriver SelectLinkX => ByCssSelector("div[data-name='SelectLinkX']").Wait();
        ...
        public LabelFieldDriver TimeStartLabel => ByCssSelector("div[data-name='TimeStartLabel']").Wait();
        public TimeFieldDriver TimeStart => ByCssSelector("div[data-name='TimeStart']").Wait();
        public LabelFieldDriver TimeEndLabel => ByCssSelector("div[data-name='TimeEndLabel']").Wait();
        public TimeFieldDriver TimeEnd => ByCssSelector("div[data-name='TimeEnd']").Wait();
        ...
        public FieldSearchCondition2DetailLayout(IWebElement element) : base(element) { }

        public static implicit operator FieldSearchCondition2DetailLayout(ElementFinder finder) => finder.Find<FieldSearchCondition2DetailLayout>();
    }

    public class FieldSearchCondition2DetailPage : DetailPage<FieldSearchCondition2DetailLayout>
    {

        public FieldSearchCondition2DetailPage(IWebDriver driver) : base(driver) { }

    }

    public static class FieldSearchCondition2DetailPageExtensions
    {

        [PageObjectIdentify(UrlCompareType.IgnoreQueryEndsWith, "/FieldSearchCondition2")]
        public static FieldSearchCondition2DetailPage AttachFieldSearchCondition2DetailPage(this IWebDriver driver)
        {
            driver.WaitForUrl(UrlCompareType.IgnoreQueryEndsWith, "/FieldSearchCondition2");
            return new FieldSearchCondition2DetailPage(driver);
        }

        [ComponentObjectIdentify]
        public static ModuleDialogDriver<FieldSearchCondition2DetailLayout> AttachFieldSearchCondition2Dialog(this IWebDriver driver)
            => new MappingBase(driver).ByCssSelector("[data-system='module-dialog'][data-module-design='FieldSearchCondition2']").Wait();
