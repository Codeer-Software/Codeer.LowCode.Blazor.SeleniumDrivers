...
namespace PageObject.Tools
{
    public static class CaptureAttachTreeMenuAction
    {
        ...
        [MenuAction]
        public static void Assert(BooleanFieldDriver booleanField, string accessPath)
            => CaptureAdaptor.AddCode(accessPath + ".Checked.Is(" + booleanField.Checked.ToString().ToLower() + ");");
